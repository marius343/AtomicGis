...
bool t_bound_box::intersects(const t_bound_box& rect, unsigned polarity) {
    bool noOverlap;

    if (polarity == 1) {
        noOverlap = bottomleft.x > rect.top_right().x || rect.bottom_left().x > topright.x || topright.y > rect.top_right().y || rect.bottom_left().y > bottomleft.y;
    } else if (polarity == 2) {
        noOverlap = bottomleft.x > rect.top_right().x || rect.bottom_left().x > topright.x || topright.y > rect.bottom_left().y || rect.top_right().y > bottomleft.y;
    } else {
        noOverlap = bottomleft.x > rect.top_right().x || rect.bottom_left().x > topright.x || bottomleft.y > rect.top_right().y || rect.bottom_left().y > topright.y;
    }

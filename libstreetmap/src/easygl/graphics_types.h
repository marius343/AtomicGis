...
public:
    ...
    //Function below checks whether two boxes intersect
    //Polarity = 0 -> bottom-left and top-right corners correct
    //polarity = 1 -> bottom-left corner is top-left & top-right is bottom-right only one one of the t_bound_box (the one not being passed to the function)
    //polarity = 2 -> bottom-left corner is top-left & top-right is bottom-right on both of the t_bound_boxes
    bool intersects(const t_bound_box& rect, unsigned polarity);
    /**
